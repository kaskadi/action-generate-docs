...
| :----: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lambda | <ul><li>method.request.header.Authorization</li><li>method.request.header.some-header</li><li>method.request.queryStringParameter.token</li><li>context.identity.sourceIp</li></ul> |
